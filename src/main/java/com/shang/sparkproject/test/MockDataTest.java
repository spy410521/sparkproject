...
import com.shang.sparkproject.util.StringUtils;
...
public class MockDataTest {
	...
	public static void mock(JavaSparkContext sc,
		...
		StructType schema = DataTypes.createStructType(Arrays.asList(
				...
				DataTypes.createStructField("searc2h_keyword", DataTypes.StringType, true),
...
//		df.toJavaRDD().coalesce(1).saveAsTextFile("/Users/spy/Desktop/myFile/output/df/");
//		df2.toJavaRDD().coalesce(1).saveAsTextFile("/Users/spy/Desktop/myFile/output/df2/");

//		df.write().text("/Users/spy/Desktop/myFile/output/df/");
//		df.write().text("/Users/spy/Desktop/myFile/output/df2/");
